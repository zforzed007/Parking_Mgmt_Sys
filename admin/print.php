...
<?php
 $cid=$_GET['vid'];
$ret=mysqli_query($con,"select o.OwnerName,o.OwnerContactNumber,tv.* from tblvehicle tv,owner o 
where tv.RegistrationNumber=o.RegistrationNumber AND tv.ID='$cid'");
$cnt=1;
