...
if(isset($_POST['submit']))
  {
    ...
    $query1=mysqli_query($con, "insert into  tblvehicle(ParkingNumber,VehicleCategory,VehicleCompanyname,RegistrationNumber) value('$parkingnumber','$catename','$vehcomp','$vehreno')");
    $query2=mysqli_query($con, "insert into  owner(OwnerName,OwnerContactNumber,RegistrationNumber) value('$ownername','$ownercontno','$vehreno')");
    if ($query1 && $query2) {
